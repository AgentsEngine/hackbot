# Remove `packages/hackbot/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/hackbot/src/storage/db.ts` module.
...
Production imports from `packages/hackbot/src/storage/db.ts` are concentrated in 22 source files:

- `packages/hackbot/src/account/repo.ts`
- `packages/hackbot/src/cli/cmd/db.ts`
- `packages/hackbot/src/cli/cmd/import.ts`
- `packages/hackbot/src/cli/cmd/stats.ts`
- `packages/hackbot/src/control-plane/workspace.ts`
- `packages/hackbot/src/index.ts`
- `packages/hackbot/src/node.ts`
- `packages/hackbot/src/permission/index.ts`
- `packages/hackbot/src/project/project.ts`
- `packages/hackbot/src/server/projectors.ts`
- `packages/hackbot/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/hackbot/src/server/shared/fence.ts`
- `packages/hackbot/src/session/message-v2.ts`
- `packages/hackbot/src/session/projectors.ts`
- `packages/hackbot/src/session/prompt.ts`
- `packages/hackbot/src/session/session.ts`
- `packages/hackbot/src/session/todo.ts`
- `packages/hackbot/src/share/share-next.ts`
- `packages/hackbot/src/storage/db.ts`
- `packages/hackbot/src/sync/index.ts`
- `packages/hackbot/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/hackbot/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/hackbot/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/hackbot`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/hackbot/src`
- `bun typecheck` from `packages/hackbot`
- Relevant package tests from `packages/hackbot`, not the repo root
