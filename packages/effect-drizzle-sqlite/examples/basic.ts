...
class Database extends Context.Service<Database, DatabaseShape>()("@hackbot/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@hackbot/example/UserStore") {
