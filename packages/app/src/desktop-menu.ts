...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "hackbot Documentation", href: "https://example.com/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/agentsengine/hackbot/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/agentsengine/hackbot/issues/new?template=bug_report.yml",
      },
    ],
  },
]
