...
import { Switch } from "hackbot-ui/v2/switch-v2"
import { TextInputV2 } from "hackbot-ui/v2/text-input-v2"
import { useTheme, type ColorScheme } from "hackbot-ui/theme/context"
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_HACKBOT_CHANNEL !== "prod"}>
          <SettingsRowV2
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <Link class="settings-v2-link" href="https://example.com/docs/themes/">
