export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "hackbotが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、hackbotで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してhackbotで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、hackbotで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "hackbot.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するhackbotサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "hackbotを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のhackbotを確認中...",
  "wsl.onboarding.updatingOpencode": "hackbotを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のhackbotを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のhackbotを更新してください。",
  "wsl.onboarding.updateOpencode": "hackbotを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のhackbotの準備ができました。",
  "wsl.onboarding.opencodeReady": "hackbotの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にhackbotをインストールしてください。",
  "wsl.onboarding.installOpencode": "hackbotをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbotがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "hackbotでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、hackbotをもう一度開いてください。",
  ...
  "toast.update.description": "hackbotの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをhackbotチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: hackbotはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "hackbotには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でhackbotサーバーを実行します。",
  ...
  "settings.general.row.language.description": "hackbotの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのhackbotの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "hackbotがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "hackbotのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "hackbot の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "hackbot は最新バージョンです。",
