export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez hackbot",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w hackbot.",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w hackbot.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w hackbot.",
  ...
  "dialog.server.description": "Przełącz serwer hackbot, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie hackbot...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie hackbot w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie hackbot...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie hackbot w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj hackbot w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj hackbot",
  "wsl.onboarding.opencodeReadyIn": "hackbot jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "hackbot jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj hackbot w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj hackbot",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim hackbot będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "hackbot nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz hackbot.",
  ...
  "toast.update.description": "Nowa wersja hackbot ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu hackbot",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: hackbot nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "hackbot zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer hackbot wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla hackbot",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd hackbot na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy hackbot ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw hackbot.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania hackbot",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji hackbot.",
