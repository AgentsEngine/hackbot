export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo hackbot",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no hackbot.",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no hackbot.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no hackbot.",
  ...
  "dialog.server.description": "Trocar para qual servidor hackbot este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o hackbot...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o hackbot em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o hackbot...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o hackbot em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o hackbot em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o hackbot",
  "wsl.onboarding.opencodeReadyIn": "O hackbot está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O hackbot está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o hackbot em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o hackbot",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o hackbot possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O hackbot não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o hackbot novamente.",
  ...
  "toast.update.description": "Uma nova versão do hackbot ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do hackbot",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: hackbot ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "hackbot inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor hackbot dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do hackbot",
  ...
  "settings.general.row.appearance.description": "Personalize como o hackbot aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o hackbot segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o hackbot é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o hackbot iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do hackbot.",
