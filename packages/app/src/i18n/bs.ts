export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje hackbot",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u hackbot-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u hackbot-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u hackbot-u.",
  ...
  "dialog.server.description": "Promijeni na koji se hackbot server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera hackbot...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera hackbot u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje hackbot...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje hackbot u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj hackbot u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj hackbot",
  "wsl.onboarding.opencodeReadyIn": "hackbot je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "hackbot je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj hackbot u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj hackbot",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi hackbot mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "hackbot nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori hackbot.",
  ...
  "toast.update.description": "Nova verzija hackbot-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku hackbot timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: hackbot još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "hackbot uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni hackbot server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u hackbot-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako hackbot izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li hackbot prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu hackbot-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se hackbot pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju hackbot-a.",
