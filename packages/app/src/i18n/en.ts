export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by hackbot",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in hackbot.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "hackbot Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in hackbot.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in hackbot.",
  ...
  "dialog.server.description": "Switch which hackbot server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking hackbot...",
  "wsl.onboarding.checkingOpencodeIn": "Checking hackbot in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating hackbot...",
  "wsl.onboarding.updatingOpencodeIn": "Updating hackbot in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update hackbot in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update hackbot",
  "wsl.onboarding.opencodeReadyIn": "hackbot is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "hackbot is ready.",
  "wsl.onboarding.installOpencodeIn": "Install hackbot in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install hackbot",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before hackbot can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "hackbot could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen hackbot.",
  ...
  "toast.update.description": "A new version of hackbot ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the hackbot team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, hackbot does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "hackbot includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the hackbot server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for hackbot",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how hackbot looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether hackbot follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how hackbot is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when hackbot launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of hackbot.",
