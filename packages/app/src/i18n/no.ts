...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av hackbot",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i hackbot.",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i hackbot.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i hackbot.",
  ...
  "dialog.server.description": "Bytt hvilken hackbot-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av hackbot ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til hackbot-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at hackbot ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "hackbot inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør hackbot-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for hackbot",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan hackbot ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om hackbot skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan hackbot er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når hackbot starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av hackbot.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker hackbot...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker hackbot i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer hackbot...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer hackbot i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater hackbot i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater hackbot",
  "wsl.onboarding.opencodeReadyIn": "hackbot er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "hackbot er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer hackbot i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før hackbot kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "hackbot kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter hackbot på nytt.",
