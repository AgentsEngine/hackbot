export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por hackbot",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en hackbot.",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en hackbot.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en hackbot.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de hackbot se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando hackbot...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando hackbot en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando hackbot...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando hackbot en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza hackbot en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar hackbot",
  "wsl.onboarding.opencodeReadyIn": "hackbot está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "hackbot está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala hackbot en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar hackbot",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que hackbot pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "hackbot no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir hackbot.",
  ...
  "toast.update.description": "Una nueva versión de hackbot ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de hackbot",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, hackbot no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "hackbot incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor hackbot dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para hackbot",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve hackbot en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si hackbot sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de hackbot.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia hackbot",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de hackbot.",
