export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par hackbot",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans hackbot.",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans hackbot.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans hackbot.",
  ...
  "dialog.server.description": "Changez le serveur hackbot auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'hackbot...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'hackbot dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'hackbot...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'hackbot dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour hackbot dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour hackbot",
  "wsl.onboarding.opencodeReadyIn": "hackbot est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "hackbot est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez hackbot dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer hackbot",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'hackbot puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "hackbot n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez hackbot.",
  ...
  "toast.update.description":
    "Une nouvelle version d'hackbot ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe hackbot",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'hackbot ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "hackbot inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur hackbot dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour hackbot",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'hackbot sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si hackbot suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'hackbot.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'hackbot",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'hackbot.",
