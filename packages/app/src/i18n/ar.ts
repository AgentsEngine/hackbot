export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من hackbot",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في hackbot.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك hackbot Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في hackbot.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في hackbot.",
  ...
  "dialog.server.description": "تبديل خادم hackbot الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من hackbot...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من hackbot في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث hackbot...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث hackbot في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث hackbot في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث hackbot",
  "wsl.onboarding.opencodeReadyIn": "hackbot جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "hackbot جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت hackbot في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت hackbot",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن hackbot من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على hackbot التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح hackbot.",
  ...
  "toast.update.description": "نسخة جديدة من hackbot ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق hackbot",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن hackbot لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن hackbot نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم hackbot داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ hackbot",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور hackbot على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان hackbot يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة hackbot.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل hackbot",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من hackbot.",
