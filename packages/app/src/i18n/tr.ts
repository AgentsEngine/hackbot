...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "hackbot tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve hackbot'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak hackbot'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak hackbot'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi hackbot sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "hackbot kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde hackbot kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "hackbot güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde hackbot güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki hackbot'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "hackbot'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde hackbot hazır.",
  "wsl.onboarding.opencodeReady": "hackbot hazır.",
  "wsl.onboarding.installOpencodeIn": "hackbot'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "hackbot'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "hackbot'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "hackbot bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından hackbot'u tekrar açın.",
  ...
  "toast.update.description": "hackbot'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı hackbot ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: hackbot henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "hackbot ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "hackbot Masaüstü",
  ...
  "settings.desktop.wsl.description": "hackbot sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "hackbot'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "hackbot'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "hackbot'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "hackbot'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "hackbot başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "hackbot'un en son sürümünü kullanıyorsunuz.",
