export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af hackbot",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i hackbot.",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i hackbot.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i hackbot.",
  ...
  "dialog.server.description": "Skift hvilken hackbot-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker hackbot...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker hackbot i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer hackbot...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer hackbot i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater hackbot i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater hackbot",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før hackbot kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "hackbot kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter hackbot igen.",
  ...
  "toast.update.description": "En ny version af hackbot ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til hackbot-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, hackbot understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "hackbot inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør hackbot-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for hackbot",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan hackbot ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om hackbot følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan hackbot er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når hackbot starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af hackbot.",
