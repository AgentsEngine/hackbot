...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von hackbot",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in hackbot zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "hackbot Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.opencodeZen.visit.link": "example.com/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in hackbot zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in hackbot zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den hackbot-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "hackbot",
  ...
  "wsl.onboarding.checkingOpencode": "hackbot wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "hackbot in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "hackbot wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "hackbot in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie hackbot in {{distro}}.",
  "wsl.onboarding.updateOpencode": "hackbot aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "hackbot ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "hackbot ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie hackbot in {{distro}}.",
  "wsl.onboarding.installOpencode": "hackbot installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "hackbot nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor hackbot einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "hackbot konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann hackbot erneut.",
  ...
  "toast.update.description": "Eine neue Version von hackbot ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem hackbot-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: hackbot unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "hackbot enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "hackbot Desktop",
  ...
  "settings.desktop.wsl.description": "hackbot-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für hackbot ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie hackbot auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob hackbot dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von hackbot anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von hackbot automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von hackbot.",
