...
- Effect plugins import `@hackbot/plugin/v2/effect`, not `@hackbot/core`.
- Public domain values use generated `@hackbot/sdk` types.
...
- Define `PluginHost` domain capabilities in `@hackbot/plugin/v2/effect`.
