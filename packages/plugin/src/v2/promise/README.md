...
The Promise plugin API is the async/await equivalent of `@hackbot/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@hackbot/plugin/v2/promise"
