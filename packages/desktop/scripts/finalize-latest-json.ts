...
const releaseId = process.env.HACKBOT_RELEASE
if (!releaseId) throw new Error("HACKBOT_RELEASE is required")

const version = process.env.HACKBOT_VERSION
if (!version) throw new Error("HACKBOT_VERSION is required")
