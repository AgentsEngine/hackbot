export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von hackbot",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von hackbot wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
