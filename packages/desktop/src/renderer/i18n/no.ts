export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av hackbot",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av hackbot er lastet ned. Vil du installere den og starte på nytt?",
