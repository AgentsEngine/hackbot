export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju hackbot-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} hackbot-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
