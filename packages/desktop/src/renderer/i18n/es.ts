export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de hackbot",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de hackbot. ¿Quieres instalarla y reiniciar?",
