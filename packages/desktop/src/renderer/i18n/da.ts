export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af hackbot",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af hackbot er blevet downloadet. Vil du installere den og genstarte?",
