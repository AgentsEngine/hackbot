export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'hackbot",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'hackbot a été téléchargée. Voulez-vous l'installer et redémarrer ?",
