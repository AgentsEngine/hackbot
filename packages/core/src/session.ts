...
import { ListAnchor } from "hackbot-schema/session"
...
import { SessionDurable } from "hackbot-schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/v2/Session") {}
