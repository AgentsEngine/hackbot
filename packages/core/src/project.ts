...
export interface Interface {
   ...
   *
   * This exists while the old hackbot project service and this core project
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/ProjectV2") {}
