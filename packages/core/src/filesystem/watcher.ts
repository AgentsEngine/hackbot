...
import { FileSystemWatcher } from "@hackbot/schema/filesystem-watcher"
...
declare const HACKBOT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof HACKBOT_LIBC === "undefined" ? undefined : HACKBOT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.HACKBOT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.HACKBOT_EXPERIMENTAL_FILEWATCHER)) {
