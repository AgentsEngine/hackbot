...
export class Service extends Context.Service<Service, Interface>()("@hackbot/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.HACKBOT_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
