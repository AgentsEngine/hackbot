...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@hackbot/llm"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/v2/ToolRegistry") {}
