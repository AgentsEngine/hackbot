...
import { Event } from "@hackbot/schema/project-directories"
import { ProjectCopy } from "@hackbot/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/ProjectCopy") {}
