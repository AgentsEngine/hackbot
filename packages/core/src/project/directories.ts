...
import type { EffectDrizzleSqlite } from "hackbot-effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/ProjectDirectories") {}
