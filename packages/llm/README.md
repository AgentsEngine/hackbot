...
Schema-first LLM core for hackbot. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@hackbot-ai/llm"
import { OpenAI } from "@hackbot-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@hackbot-ai/llm/providers"
