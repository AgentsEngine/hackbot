...
> current private `@hackbot-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@hackbot-ai/ai`
...
- Secondary audience: hackbot and other durable agent runtimes
...
import { LLM } from "@hackbot-ai/ai"
import { OpenAI } from "@hackbot-ai/ai/providers/openai"
...
```ts
import { Message } from "@hackbot-ai/ai"
...
import { LLM, Tool } from "@hackbot-ai/ai"
...
hackbot and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@hackbot-ai/ai/promise"
import { OpenAI } from "@hackbot-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@hackbot-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@hackbot-ai/ai/provider"
...
@hackbot-ai/ai/promise
  Promise/AsyncIterable LLM facade

@hackbot-ai/ai/schema
  serializable domain schemas

@hackbot-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@hackbot-ai/ai/providers/openai
@hackbot-ai/ai/providers/anthropic
@hackbot-ai/ai/providers/google
...
```
...
hackbot should migrate to `generateTurn` / `streamTurn`, preserving its durable
