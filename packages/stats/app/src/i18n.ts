...
const en = {
  "app.title": "AI Model Usage Rankings | Hackbot Data",
  "app.description":
    "Explore Hackbot Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Hackbot Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Hackbot on GitHub",
  "header.github": "GitHub",
  "header.tryhackbot": "Try hackbot",
  ...
  "home.topModelsDescription": "Usage of models across Hackbot Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Hackbot Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Hackbot Data",
  "lab.description":
    "Compare {{lab}} models used in Hackbot Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Hackbot usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Hackbot",
  ...
  "lab.shareOfUsage": "{{share}} of recent Hackbot usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Hackbot Data",
  "model.description":
    "View {{model}} Hackbot Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Hackbot Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Hackbot Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Hackbot Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Hackbot Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Hackbot Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Hackbot Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Hackbot Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Hackbot Go token volume.",
