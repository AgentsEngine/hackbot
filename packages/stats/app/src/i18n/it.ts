export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | hackbot Data",
  "app.description":
    "Esplora l'utilizzo di hackbot Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo hackbot Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a hackbot su GitHub",
  "header.github": "GitHub",
  "header.tryhackbot": "Prova hackbot",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in hackbot Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di hackbot Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | hackbot Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in hackbot Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di hackbot.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in hackbot",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di hackbot",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token hackbot negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | hackbot Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in hackbot Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di hackbot Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo hackbot Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo hackbot Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di hackbot Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di hackbot Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di hackbot Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token hackbot Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di hackbot Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione hackbot Go.",
  ...
  "model.geoDescription": "Token del modello hackbot Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica hackbot Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token hackbot Go.",
