export const dict = {
  "app.title": "Rankingi użycia modeli AI | hackbot Data",
  "app.description":
    "Przeglądaj użycie hackbot Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny hackbot Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę hackbot na GitHub",
  "header.github": "GitHub",
  "header.tryhackbot": "Wypróbuj hackbot",
  ...
  "footer.homeAria": "Strona główna hackbot",
  ...
  "home.topModelsDescription": "Użycie modeli w hackbot Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy hackbot Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | hackbot Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w hackbot Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia hackbot.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w hackbot",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia hackbot",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów hackbot z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | hackbot Data",
  "model.description":
    "Zobacz dane użycia {{model}} w hackbot Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie hackbot Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu hackbot Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu hackbot Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia hackbot Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny hackbot Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia hackbot Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów hackbot Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy hackbot Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji hackbot Go.",
  ...
  "model.geoDescription": "Tokeny modelu hackbot Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne hackbot Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów hackbot Go.",
