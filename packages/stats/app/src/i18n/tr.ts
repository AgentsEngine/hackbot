export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | hackbot Data",
  "app.description":
    "hackbot Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde hackbot Data logosu",
  ...
  "header.githubAria": "GitHub'da hackbot'a yıldız ver",
  "header.github": "GitHub",
  "header.tryhackbot": "hackbot'u dene",
  ...
  "footer.homeAria": "hackbot ana sayfası",
  ...
  "home.topModelsDescription": "hackbot Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz hackbot Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | hackbot Data",
  "lab.description":
    "hackbot Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son hackbot kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "hackbot'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son hackbot kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük hackbot token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | hackbot Data",
  "model.description":
    "{{model}} için hackbot Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda hackbot Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki hackbot Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki hackbot Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde hackbot Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son hackbot Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz hackbot Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük hackbot Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz hackbot Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama hackbot Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan hackbot Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen hackbot Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son hackbot Go token hacmine göre yakındaki modeller.",
