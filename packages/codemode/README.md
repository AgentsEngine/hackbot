...
```ts
import { CodeMode, Tool } from "@hackbot/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@hackbot/codemode"
...
```ts
import { toolError } from "@hackbot/codemode"
