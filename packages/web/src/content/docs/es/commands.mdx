...
Crear `.hackbot/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Hackbot o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Hackbot [config](/docs/config):
...
hackbot incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
