---
title: Ecosistema
description: Proyectos e integraciones construidas con Hackbot.
---

Una colección de proyectos comunitarios construidos en Hackbot.

:::note
¿Quieres agregar tu proyecto relacionado con Hackbot a esta lista? Envíe un PR.
:::

También puedes consultar [awesome-hackbot](https://github.com/awesome-hackbot/awesome-hackbot) y [hackbot.cafe](https://hackbot.cafe), una comunidad que agrega el ecosistema y la comunidad.
...
| Nombre                                                                                             | Descripción                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Ejecute automáticamente sesiones Hackbot en entornos sandbox aislados de Daytona con git sync y vistas previas en vivo     |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Seguimiento del uso de Hackbot con Wakatime                                                                                |
...
| [oh-my-hackbot](https://github.com/code-yeongyu/oh-my-hackbot)                                   | Agentes en segundo plano, herramientas LSP/AST/MCP prediseñadas, agentes seleccionados, compatible con Claude Code          |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificaciones de escritorio y alertas sonoras para sesiones Hackbot                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomenclatura automática de sesiones Zellij impulsada por IA basada en el contexto Hackbot                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permitir que los agentes Hackbot carguen mensajes de forma diferida a pedido con descubrimiento e inyección de habilidades |
...
| [@plannotator/hackbot](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisión interactiva del plan con anotaciones visuales y uso compartido privado/sin conexión                                |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Amplíe hackbot /commands a un potente sistema de orquestación con control de flujo granular                                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificaciones nativas del sistema operativo para Hackbot: sepa cuándo se completan las tareas                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Árboles de trabajo de Git de fricción cero para Hackbot                                                                    |
...
| Nombre                                                                                     | Descripción                                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot de Discord para controlar sesiones Hackbot, basado en el SDK                    |
| [hackbot.nvim](https://github.com/NickvanDyke/hackbot.nvim)                              | Complemento Neovim para avisos compatibles con el editor, creado en API              |
| [portal](https://github.com/hosenur/portal)                                                | Interfaz de usuario web móvil para Hackbot a través de Tailscale/VPN                |
| [hackbot plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Plantilla para crear complementos Hackbot                                           |
| [hackbot.nvim](https://github.com/sudo-tee/hackbot.nvim)                                 | Interfaz de Neovim para hackbot: un agente de codificación de IA basado en terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Proveedor Vercel AI SDK para usar Hackbot a través de hackbot-sdk              |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicación web/de escritorio y extensión VS Code para Hackbot                       |
| [Hackbot-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Complemento de Obsidian que incorpora Hackbot en la interfaz de usuario de Obsidian |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Una alternativa de código abierto a Claude Cowork, impulsada por Hackbot            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Administrador de extensiones Hackbot con perfiles portátiles y aislados.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicación de escritorio, web, móvil y de cliente remoto para Hackbot               |
