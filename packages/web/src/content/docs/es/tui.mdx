---
title: TUI
description: Usando la interfaz de usuario del terminal Hackbot.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Hackbot proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Hackbot se inicia TUI para el directorio actual.
...
Cuando utilice Hackbot TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Hackbot. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Hackbot. _Alias_: `/quit`, `/q`
...
Esto es independiente de `hackbot.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera Hackbot después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `hackbot.default`.
