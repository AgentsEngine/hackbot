---
title: Zen
description: Lista seleccionada de modelos proporcionada por Hackbot.
---
...
Hackbot Zen es una lista de modelos probados y verificados proporcionada por el equipo de Hackbot.

Zen funciona como cualquier otro proveedor en Hackbot. Inicias sesión en Hackbot Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Hackbot.
:::
...
Hackbot Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Hackbot Zen funciona como cualquier otro proveedor en Hackbot.

1. Inicias sesión en **<a href={console}>Hackbot Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Hackbot Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Hackbot
usa el formato `hackbot/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`hackbot/gpt-5.5` en tu configuración.
...
Puede que notes [modelos de bajo costo](/docs/config/#models), como Haiku, Nano o Flash, en tu historial de uso. Hackbot usa estos modelos para generar títulos de sesiones.
...
- DeepSeek V4 Flash Free está disponible en Hackbot por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en Hackbot por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- North Mini Code Free está disponible en Hackbot por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en Hackbot por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- White Horse es un modelo stealth que es gratuito en Hackbot por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
- White Horse: Durante su período gratuito, los datos recopilados pueden usarse para mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Hackbot.
