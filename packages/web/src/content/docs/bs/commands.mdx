...
Kreiraj `.hackbot/commands/test.md`:
...
Možete dodati prilagođene komande kroz Hackbot konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Hackbot [config](/docs/config):
...
- Globalno: `~/.config/hackbot/commands/`
- Po projektu: `.hackbot/commands/`
...
Hackbot uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
