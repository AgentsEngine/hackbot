---
title: TUI
description: Korištenje korisničkog interfejsa Hackbot terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Hackbot pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Hackbot pokreće TUI za trenutni direktorij.
...
Kada koristite Hackbot TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Hackbot. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Hackbot. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `hackbot.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Hackbot čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `hackbot.default`.
