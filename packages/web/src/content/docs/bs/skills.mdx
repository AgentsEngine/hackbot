...
Agent skills omogucavaju Hackbot da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Hackbot pretrazuje ove lokacije:

- Konfiguracija projekta: `.hackbot/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/hackbot/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Hackbot ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.hackbot/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/hackbot/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.hackbot/skills/git-release/SKILL.md` ovako:
...
Hackbot navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `hackbot.json`:
...
**Za ugradene agente** (u `hackbot.json`):
