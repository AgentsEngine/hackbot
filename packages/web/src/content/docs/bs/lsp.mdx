---
title: LSP serveri
description: Hackbot se integriše sa vašim LSP serverima.
---

Hackbot se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Hackbot dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `HACKBOT_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i hackbot otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj hackbot konfiguraciji.
