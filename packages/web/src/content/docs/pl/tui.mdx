---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala hackbot.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

hackbot zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie hackbot uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI hackbot, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do hackbot. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij hackbot. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `hackbot.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Hackbot czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `hackbot.default`.
