---
title: Ekosystem
description: Projekty i integracje zbudowane przy użyciu Hackbot.
---

Zbiór projektów społeczności zbudowanych na Hackbot.

:::note
Chcesz dodać swój projekt związany z Hackbot do tej listy? Prześlij PR.
:::

Możesz również sprawdzić [awesome-hackbot](https://github.com/awesome-hackbot/awesome-hackbot) oraz [hackbot.cafe](https://hackbot.cafe), społeczność agregującą ekosystem i społeczność.
...
| Nazwa                                                                                              | Opis                                                                                                                  |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatyczne uruchamianie sesji Hackbot w izolowanych piaskownicach Daytona z synchronizacją git i podglądem na żywo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Śledź użycie Hackbot za pomocą Wakatime                                                                              |
...
| [oh-my-hackbot](https://github.com/code-yeongyu/oh-my-hackbot)                                   | Agenci w tle, wbudowane narzędzia LSP/AST/MCP, wyselekcjonowani agenci, kompatybilność z Claude Code                  |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Powiadomienia na pulpicie i alerty dźwiękowe dla sesji Hackbot                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatyczne nazywanie sesji Zellij oparte na AI w oparciu o kontekst Hackbot                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Pozwól agentom Hackbot na leniwe ładowanie promptów na żądanie z odkrywaniem umiejętności i wstrzykiwaniem           |
...
| [@plannotator/hackbot](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktywny przegląd planów z wizualnymi adnotacjami i prywatnym/offline udostępnianiem                              |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Rozszerz komendy /commands Hackbot w potężny system orkiestracji ze szczegółową kontrolą przepływu                   |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Natywne powiadomienia systemowe dla Hackbot – wiedz, kiedy zadania się zakończą                                      |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Bezproblemowe drzewa robocze git dla Hackbot                                                                         |
...
| Nazwa                                                                                      | Opis                                                                    |
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord do sterowania sesjami Hackbot, zbudowany na SDK            |
| [hackbot.nvim](https://github.com/NickvanDyke/hackbot.nvim)                              | Wtyczka Neovim dla promptów świadomych edytora, zbudowana na API        |
| [portal](https://github.com/hosenur/portal)                                                | Interfejs webowy mobile-first dla Hackbot przez Tailscale/VPN          |
| [hackbot plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Szablon do tworzenia wtyczek Hackbot                                   |
| [hackbot.nvim](https://github.com/sudo-tee/hackbot.nvim)                                 | Frontend Neovim dla Hackbot - terminalowy agent kodujący AI            |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Dostawca Vercel AI SDK do używania Hackbot przez hackbot-sdk      |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplikacja Web / Desktop i rozszerzenie VS Code dla Hackbot             |
| [Hackbot-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Wtyczka Obsidian osadzająca Hackbot w interfejsie Obsidian             |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Otwartoźródłowa alternatywa dla Claude Cowork, napędzana przez Hackbot |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Menedżer rozszerzeń Hackbot z przenośnymi, izolowanymi profilami.      |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplikacja kliencka Desktop, Web, Mobile i Remote dla Hackbot           |
