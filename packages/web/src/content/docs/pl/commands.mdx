...
Utwórz `.hackbot/commands/test.md`:
...
Możesz zdefiniować polecenia w `hackbot.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji hackbot:
...
- Globalnie: `~/.config/hackbot/commands/`
- Na projekt: `.hackbot/commands/`
...
hackbot zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
