---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Hackbot.
---
...
Hackbot Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Hackbot.

Zen działa jak każdy inny dostawca w Hackbot. Logujesz się do Hackbot Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Hackbot.
:::
...
Hackbot Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Hackbot Zen działa jak każdy inny dostawca w Hackbot.

1. Logujesz się do **<a href={console}>Hackbot Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Hackbot Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Hackbot używa formatu
`hackbot/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`hackbot/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. Hackbot używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w Hackbot przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Hackbot przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w Hackbot przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Hackbot przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- White Horse to stealth model, który jest darmowy w Hackbot przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
- White Horse: W czasie darmowego okresu zebrane dane mogą być wykorzystywane do ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Hackbot także dowolnego innego dostawcy.
