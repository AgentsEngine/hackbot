---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące hackbot.
---

Funkcja udostępniania hackbot umożliwia tworzenie publicznych linków do konwersacji hackbot, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, hackbot:
...
hackbot obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie hackbot korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `hackbot.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu hackbot w Twojej organizacji.
