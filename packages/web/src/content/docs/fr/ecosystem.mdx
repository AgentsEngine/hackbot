---
title: Écosystème
description: Projets et intégrations construits avec Hackbot.
---

Une collection de projets communautaires construits sur Hackbot.

:::note
Vous souhaitez ajouter votre projet lié à Hackbot à cette liste ? Soumettez une PR.
:::

Vous pouvez également consulter [awesome-hackbot](https://github.com/awesome-hackbot/awesome-hackbot) et [hackbot.cafe](https://hackbot.cafe), une communauté qui regroupe l'écosystème et la communauté.
...
| Nom                                                                                                | Description                                                                                                                            |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Exécute automatiquement des sessions Hackbot dans des sandbox Daytona isolées avec synchronisation git et prévisualisations en direct |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Suit l'utilisation d'Hackbot avec Wakatime                                                                                            |
...
| [oh-my-hackbot](https://github.com/code-yeongyu/oh-my-hackbot)                                   | Agents d'arrière-plan, outils LSP/AST/MCP pré-construits, agents sélectionnés, compatible Claude Code                                  |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifications de bureau et alertes sonores pour les sessions Hackbot                                                                  |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nommage automatique de session Zellij alimenté par l'IA basé sur le contexte Hackbot                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permet aux agents Hackbot le chargement différé de prompts à la demande avec découverte et injection de compétences                   |
...
| [@plannotator/hackbot](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Révision de plan interactive avec annotation visuelle et partage privé/hors ligne                                                      |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Étend hackbot /commands en un système d'orchestration puissant avec contrôle de flux granulaire                                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifications natives de l'OS pour Hackbot – sachez quand les tâches sont terminées                                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sans friction pour Hackbot                                                                                              |
...
| Nom                                                                                        | Description                                                                 |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord pour contrôler les sessions Hackbot, construit sur le SDK      |
| [hackbot.nvim](https://github.com/NickvanDyke/hackbot.nvim)                              | Plugin Neovim pour des prompts conscients de l'éditeur, construit sur l'API |
| [portal](https://github.com/hosenur/portal)                                                | Interface Web mobile-first pour Hackbot via Tailscale/VPN                  |
| [hackbot plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Modèle pour créer des plugins Hackbot                                      |
| [hackbot.nvim](https://github.com/sudo-tee/hackbot.nvim)                                 | Frontend Neovim pour hackbot - un agent de codage IA basé sur terminal     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Fournisseur Vercel AI SDK pour utiliser Hackbot via hackbot-sdk       |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Application Web / Bureau et extension VS Code pour Hackbot                 |
| [Hackbot-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian qui intègre Hackbot dans l'interface d'Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Une alternative open-source à Claude Cowork, propulsée par Hackbot         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestionnaire d'extensions Hackbot avec profils portables et isolés.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Application client Bureau, Web, Mobile et Distante pour Hackbot            |
