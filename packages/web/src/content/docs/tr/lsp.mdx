...
description: Hackbot, LSP sunucularınızla bütünleşir.
---

Hackbot, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

Hackbot, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`HACKBOT_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
LSP etkinleştirildiğinde ve hackbot bir dosyayı açtığında:
...
LSP sunucularını, hackbot yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
