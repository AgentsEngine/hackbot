---
title: Özel Araçlar
description: LLM'un hackbot'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. hackbot'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.hackbot/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/hackbot/tools/` içine yerleştirerek.
