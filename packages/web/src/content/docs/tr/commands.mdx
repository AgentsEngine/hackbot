...
`.hackbot/commands/test.md` oluştur:
...
hackbot işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

hackbot [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/hackbot/commands/`
- Proje başına: `.hackbot/commands/`
...
hackbot, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
