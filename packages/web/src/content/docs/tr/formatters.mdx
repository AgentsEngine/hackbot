...
description: hackbot dile özgü biçimlendiriciler kullanır.
---

hackbot, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

hackbot, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, hackbot bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

hackbot bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri hackbot yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
