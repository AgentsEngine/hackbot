---
title: Paylasim
description: hackbot konusmalarini genel baglantilarla paylasin.
---

hackbot'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda hackbot:
...
hackbot, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak hackbot manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `hackbot.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda hackbot kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
