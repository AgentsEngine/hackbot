---
title: TUI
description: استخدام واجهة المستخدم TUI في Hackbot.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Hackbot واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Hackbot إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Hackbot في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Hackbot. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Hackbot. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `hackbot.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Hackbot بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `hackbot.default`.
