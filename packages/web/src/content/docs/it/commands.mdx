...
Puoi aggiungere comandi personalizzati tramite la config di Hackbot o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Hackbot:
...
- Globale: `~/.config/hackbot/commands/`
- Per progetto: `.hackbot/commands/`
...
hackbot include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
