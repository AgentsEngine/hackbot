---
title: Ecosistema
description: Progetti e integrazioni costruiti con Hackbot.
---

Una raccolta di progetti della comunità costruiti su Hackbot.

:::note
Vuoi aggiungere il tuo progetto legato a Hackbot a questa lista? Apri una PR.
:::

Puoi anche dare un'occhiata a [awesome-hackbot](https://github.com/awesome-hackbot/awesome-hackbot) e [hackbot.cafe](https://hackbot.cafe), una comunità che aggrega ecosistema e community.
...
| Nome                                                                                              | Descrizione                                                                                       |
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)           | Esegue automaticamente sessioni Hackbot in sandbox Daytona isolate con sync git e anteprime live  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                               | Traccia l'uso di Hackbot con Wakatime                                                             |
...
| [oh-my-hackbot](https://github.com/code-yeongyu/oh-my-hackbot)                                    | Agenti in background, tool LSP/AST/MCP predefiniti, agenti curati, compatibile con Claude Code    |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                           | Notifiche desktop e avvisi sonori per le sessioni Hackbot                                         |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                           | Naming automatico delle sessioni Zellij basato sul contesto Hackbot                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                               | Permette agli agenti Hackbot di caricare prompt al bisogno con discovery e injection di skill     |
...
| [@plannotator/hackbot](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisione interattiva dei piani con annotazione visiva e condivisione privata/offline             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                             | Estende hackbot /commands in un sistema di orchestrazione con controllo di flusso granulare       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                   | Notifiche native del sistema per Hackbot: sai quando i task finiscono                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                               | Git worktree senza attriti per Hackbot                                                            |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni Hackbot, costruito sull'SDK     |
| [hackbot.nvim](https://github.com/NickvanDyke/hackbot.nvim)                                | Plugin Neovim per prompt consapevoli dell'editor, costruito sull'API |
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per Hackbot su Tailscale/VPN                     |
| [hackbot plugin template](https://github.com/zenobi-us/opencode-plugin-template/)          | Template per costruire plugin Hackbot                                |
| [hackbot.nvim](https://github.com/sudo-tee/hackbot.nvim)                                   | Frontend Neovim per hackbot: un agente di coding AI per terminale    |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare Hackbot tramite hackbot-sdk         |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per Hackbot                    |
| [Hackbot-Obsidian](https://github.com/mtymek/opencode-obsidian)                            | Plugin Obsidian che integra Hackbot nella UI di Obsidian             |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da Hackbot       |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni Hackbot con profili portabili e isolati        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per Hackbot                 |
