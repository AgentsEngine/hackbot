---
title: Zen
description: Lista curata di modelli fornita da Hackbot.
---
...
Hackbot Zen è un elenco di modelli testati e verificati forniti dal team di Hackbot.

Zen funziona come qualsiasi altro provider in Hackbot. Accedi a Hackbot Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Hackbot.
:::
...
Hackbot Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Hackbot Zen funziona come qualsiasi altro provider in Hackbot.

1. Accedi a **<a href={console}>Hackbot Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Hackbot Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Hackbot
usa il formato `hackbot/<model-id>`. Per esempio, per GPT 5.5, useresti
`hackbot/gpt-5.5` nella tua config.
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. Hackbot usa questi modelli per generare i titoli delle sessioni.
...
- DeepSeek V4 Flash Free è disponibile su Hackbot per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su Hackbot per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su Hackbot per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su Hackbot per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- White Horse è un modello stealth che è gratuito su Hackbot per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
- White Horse: durante il periodo gratuito, i dati raccolti possono essere usati per migliorare il modello.
...
Abbiamo creato Hackbot Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Hackbot.
