...
สร้าง `.hackbot/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Hackbot:
...
- ระดับผู้ใช้ (Global): `~/.config/hackbot/commands/`
- ระดับโปรเจ็กต์: `.hackbot/commands/`
...
Hackbot มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
