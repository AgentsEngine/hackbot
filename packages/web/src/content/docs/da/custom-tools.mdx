...
description: Opret værktøjer, som LLM kan kalde hackbot ind.
---
...
- Lokalt ved at placere dem i biblioteket `.hackbot/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/hackbot/tools/`.
