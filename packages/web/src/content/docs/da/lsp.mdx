---
title: LSP-servere
description: Hackbot integreres med dine LSP-servere.
---

Hackbot kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Hackbot leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `HACKBOT_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og hackbot åbner en fil, vil den:
