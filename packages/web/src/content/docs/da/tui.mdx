---
title: TUI
description: Brug af Hackbot-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Hackbot giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Hackbot starter TUI for den nuværende mappe.
...
Når du bruger Hackbot TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Hackbot. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Hackbot. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `hackbot.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Hackbot venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `hackbot.default`.
