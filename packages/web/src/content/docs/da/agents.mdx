...
Der er to typer agenter i Hackbot; primære agenter og subagenter.
...
Hackbot leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Hackbot leveres med tre indbyggede subagenter, **General**, **Explore** og **Scout**. Vi ser nærmere på dem nedenfor.

---

## Indbyggede

Hackbot leveres med to indbyggede primære agenter og tre indbyggede subagenter.
...
En skrivebeskyttet agent til eksterne docs og research af dependencies. Brug denne, når du har brug for at klone et dependency-repository ind i Hackbot's administrerede cache, inspicere kildekoden i et bibliotek eller krydstjekke lokal kode mod upstream-implementeringer uden at ændre dit workspace.
...
Konfigurer agent i din `hackbot.json`-konfigurationsfil:
...
- Globalt: `~/.config/hackbot/agents/`
- Pr. projekt: `.hackbot/agents/`
...
Hvis ingen temperatur er angivet, bruger Hackbot modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Hackbot-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Hackbot-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Hackbot Zen](/docs/zen), vil du bruge `hackbot/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `hackbot models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/hackbot).
:::
