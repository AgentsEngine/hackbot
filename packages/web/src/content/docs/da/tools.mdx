...
Her er alle de innebygde verktøyene som er tilgængelige i Hackbot.
...
:::note
Dette verktøyet er bare tilgængelig når `HACKBOT_EXPERIMENTAL_LSP_TOOL=true` (eller `HACKBOT_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Hackbot-leverandøren eller når miljøvariabelen `HACKBOT_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
