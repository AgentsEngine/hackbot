...
Agentferdigheter lar Hackbot oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Hackbot søker etter disse stedene:

- Prosjektkonfigurasjon: `.hackbot/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/hackbot/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Hackbot opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.hackbot/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/hackbot/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.hackbot/skills/git-release/SKILL.md` slik:
...
Hackbot viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `hackbot.json`:
...
**For innebygde agenter** (i `hackbot.json`):
