---
title: Økosystem
description: Prosjekter og integrasjoner bygget med Hackbot.
---

En samling fellesskapsprosjekter bygget på Hackbot.

:::note
Vil du legge til ditt Hackbot-relaterte prosjekt til denne listen? Send inn en PR.
:::

Du kan også sjekke ut [awesome-hackbot](https://github.com/awesome-hackbot/awesome-hackbot) og [hackbot.cafe](https://hackbot.cafe), et fellesskap som samler økosystemet og fellesskapet.
...
| Navn                                                                                               | Beskrivelse                                                                                                   |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Kjør Hackbot-økter automatisk i isolerte Daytona-sandkasser med git-synkronisering og live-forhåndsvisninger |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor Hackbot-bruk med Wakatime                                                                               |
...
| [oh-my-hackbot](https://github.com/code-yeongyu/oh-my-hackbot)                                   | Bakgrunnsagenter, forhåndsbygde LSP/AST/MCP verktøy, kurerte agenter, Claude Code-kompatibel                  |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Skrivebordsvarsler og lydvarsler for Hackbot-økter                                                           |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-drevet automatisk Zellij-sesjonsnavn basert på Hackbot-kontekst                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Tillat Hackbot-agenter å lazy-loade meldinger på forespørsel med ferdighetsoppdagelse og injeksjon           |
...
| [@plannotator/hackbot](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktiv plangjennomgang med visuell merknad og privat/offline deling                                       |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Utvid Hackbot /kommandoer til et kraftig orkestreringssystem med granulær flytkontroll                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Innfødte OS-varsler for Hackbot – vet når oppgaver fullføres                                                 |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nullfriksjon git-arbeidstre for Hackbot                                                                      |
...
| Navn                                                                                       | Beskrivelse                                                         |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot for å kontrollere Hackbot-økter, bygget på SDK         |
| [hackbot.nvim](https://github.com/NickvanDyke/hackbot.nvim)                              | Neovim-plugin for editor-tilpassede meldinger, bygget på API        |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Hackbot over Tailscale/VPN                 |
| [hackbot plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mal for å bygge Hackbot-plugins                                    |
| [hackbot.nvim](https://github.com/sudo-tee/hackbot.nvim)                                 | Neovim-grensesnitt for Hackbot - en terminalbasert AI-kodingsagent |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK leverandør for bruk av Hackbot via hackbot-sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/skrivebordsapp og VS Code-utvidelse for Hackbot               |
| [Hackbot-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-plugin som bygger inn Hackbot i Obsidians UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et åpen kildekode-alternativ til Claude Cowork, drevet av Hackbot  |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Hackbot utvidelsesbehandler med bærbare, isolerte profiler.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile og Remote Client App for Hackbot              |
