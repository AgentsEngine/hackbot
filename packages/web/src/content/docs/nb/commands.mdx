...
Opprett `.hackbot/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Hackbot-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Hackbot [config](/docs/config):
...
Hackbot inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
