...
Det er to typer agenter i Hackbot; primære agenter og underagenter.
...
Hackbot kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Hackbot kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

Hackbot kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `hackbot.json`:
...
Hvis ingen temperatur er spesifisert, bruker Hackbot modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Hackbot-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Hackbot-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Hackbot Zen](/docs/zen), vil du bruke `hackbot/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `hackbot models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/anomalyco/hackbot).
:::
