---
title: LSP-servere
description: hackbot integreres med LSP-serverne dine.
---

Hackbot kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Hackbot kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `HACKBOT_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og hackbot åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Hackbot-konfigurasjonen.
