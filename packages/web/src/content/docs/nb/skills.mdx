...
Agentferdigheter lar Hackbot oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går hackbot opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
hackbot viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `hackbot.json`:
