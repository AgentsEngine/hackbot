---
title: Ökosystem
description: Mit Hackbot erstellte Projekte und Integrationen.
---

Eine Sammlung von Community-Projekten, die auf Hackbot basieren.

:::note
Möchten Sie Ihr Hackbot-bezogenes Projekt zu dieser Liste hinzufügen? Senden Sie einen PR.
:::

Sie können sich auch [awesome-hackbot](https://github.com/awesome-hackbot/awesome-hackbot) und [hackbot.cafe](https://hackbot.cafe) ansehen, eine Community, die das Ökosystem und die Community zusammenfasst.
...
| Name                                                                                              | Beschreibung                                                                                                                 |
| ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)           | Führen Sie Hackbot-Sitzungen automatisch in isolierten Daytona-Sandboxes mit Git-Synchronisierung und Live-Vorschauen aus    |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                               | Verfolgen Sie die Nutzung von Hackbot mit Wakatime                                                                           |
...
| [oh-my-hackbot](https://github.com/code-yeongyu/oh-my-hackbot)                                    | Hintergrundagenten, vorgefertigte LSP/AST/MCP-Tools, kuratierte Agenten, Claude Code-kompatibel                              |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                           | Desktop-Benachrichtigungen und akustische Warnungen für Hackbot-Sitzungen                                                    |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                           | AI-gestützte automatische Benennung von Zellij-Sitzungen basierend auf dem Hackbot-Kontext                                   |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                               | Ermöglichen Sie Hackbot-Agenten das verzögerte Laden von Eingabeaufforderungen bei Bedarf mit Skill-Erkennung und -Injektion |
...
| [@plannotator/hackbot](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktive Planüberprüfung mit visueller Anmerkung und private/offline-Freigabe                                             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                             | Erweitern Sie Hackbot /commands zu einem leistungsstarken Orchestrierungssystem mit granularer Flusskontrolle                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                   | Native OS-Benachrichtigungen für Hackbot – wissen, wann Aufgaben erledigt sind                                               |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                               | Reibungslose Git-Arbeitsbäume für Hackbot                                                                                    |
...
| Name                                                                                       | Beschreibung                                                            |
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-Bot zur Steuerung von Hackbot-Sitzungen, basierend auf SDK      |
| [hackbot.nvim](https://github.com/NickvanDyke/hackbot.nvim)                                | Neovim-Plugin für editorfähige Eingabeaufforderungen, basierend auf API |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-First-Web UI für Hackbot über Tailscale/VPN                      |
| [hackbot plugin template](https://github.com/zenobi-us/opencode-plugin-template/)          | Vorlage zum Erstellen von Hackbot-Plugins                               |
| [hackbot.nvim](https://github.com/sudo-tee/hackbot.nvim)                                   | Neovim-Frontend für Hackbot – ein terminalbasierter AI-Coding-Agent     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK Anbieter für die Verwendung von Hackbot über hackbot-sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/Desktop-App und VS Code-Erweiterung für Hackbot                    |
| [Hackbot-Obsidian](https://github.com/mtymek/opencode-obsidian)                            | Obsidian-Plugin, das Hackbot in Obsidians UI einbettet                  |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Eine Open-Source-Alternative zu Claude Cowork, unterstützt von Hackbot  |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Hackbot Erweiterungsmanager mit portablen, isolierten Profilen.         |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop-, Web-, Mobil- und Remote-Client-App für Hackbot                |
