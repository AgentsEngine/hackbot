---
title: Zen
description: Kuratierte Modellliste direkt von Hackbot.
---
...
Hackbot Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Hackbot-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Hackbot. Du meldest dich bei Hackbot Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Hackbot zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Hackbot funktionieren.
:::
...
Hackbot Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Hackbot Zen funktioniert wie jeder andere Provider in Hackbot.

1. Du meldest dich bei **<a href={console}>Hackbot Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Hackbot Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Hackbot-Konfiguration verwendet das Format `hackbot/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `hackbot/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. Hackbot verwendet diese Modelle, um Session-Titel zu generieren.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf Hackbot verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf Hackbot verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf Hackbot verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Hackbot verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- White Horse ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Hackbot verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
- White Horse: Während des kostenlosen Zeitraums können gesammelte Daten zur Verbesserung des Modells verwendet werden.
...
Wir haben Hackbot Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Hackbot auch jeden anderen Provider zu verwenden.
