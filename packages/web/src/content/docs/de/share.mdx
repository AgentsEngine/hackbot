---
title: Teilen
description: Teile Hackbot-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Hackbot-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Hackbot Folgendes:
...
Hackbot hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Hackbot den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`hackbot.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du hackbot in deiner Organisation einsetzt.
