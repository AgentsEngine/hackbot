...
Erstellen Sie `.hackbot/commands/test.md`:

```md title=".hackbot/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Hackbot-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Hackbot [config](/docs/config):

```json title="hackbot.jsonc" {4-12}
{
...
- Global: `~/.config/hackbot/commands/`
- Pro Projekt: `.hackbot/commands/`

```markdown title="~/.config/hackbot/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".hackbot/commands/component.md"
---
...
```md title=".hackbot/commands/create-file.md"
---
...
```md title=".hackbot/commands/analyze-coverage.md"
---
...
```md title=".hackbot/commands/review-changes.md"
---
...
```md title=".hackbot/commands/review-component.md"
---
...
Hackbot enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
