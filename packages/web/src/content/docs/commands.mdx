...
Create `.hackbot/commands/test.md`:
...
You can add custom commands through the Hackbot config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Hackbot [config](/docs/config):
...
hackbot includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
