---
title: Ecosystem
description: Projects and integrations built with Hackbot.
---

A collection of community projects built on Hackbot.

:::note
Want to add your Hackbot related project to this list? Submit a PR.
:::

You can also check out [awesome-hackbot](https://github.com/awesome-hackbot/awesome-hackbot) and [hackbot.cafe](https://hackbot.cafe), a community that aggregates the ecosystem and community.
...
| Name                                                                                               | Description                                                                                        |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run Hackbot sessions in isolated Daytona sandboxes with git sync and live previews  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Hackbot usage with Wakatime                                                                 |
...
| [oh-my-hackbot](https://github.com/code-yeongyu/oh-my-hackbot)                                   | Background agents, pre-built LSP/AST/MCP tools, curated agents, Claude Code compatible             |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Hackbot sessions                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Hackbot context                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Hackbot agents to lazy load prompts on demand with skill discovery and injection            |
...
| [@plannotator/hackbot](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interactive plan review with visual annotation and private/offline sharing                         |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend hackbot /commands into a powerful orchestration system with granular flow control          |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Hackbot – know when tasks complete                                    |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Hackbot                                                           |
...
| [opencode-goal-plugin](https://github.com/willytop8/Hackbot-goal-plugin)                          | Session-scoped `/goal` workflow that keeps objectives in context and auto-continues until complete |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control Hackbot sessions, built on the SDK       |
| [hackbot.nvim](https://github.com/NickvanDyke/hackbot.nvim)                              | Neovim plugin for editor-aware prompts, built on the API         |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Hackbot over Tailscale/VPN              |
| [hackbot plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Hackbot plugins                           |
| [hackbot.nvim](https://github.com/sudo-tee/hackbot.nvim)                                 | Neovim frontend for hackbot - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Hackbot via hackbot-sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Hackbot             |
| [Hackbot-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds Hackbot in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by Hackbot |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Hackbot extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for Hackbot          |
