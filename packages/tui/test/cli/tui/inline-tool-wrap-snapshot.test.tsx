...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/hackbot/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/hackbot (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/hackbot/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/hackbot/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const HACKBOT_DB|HACKBOT_DB|HACKBOT_DEV|Global\\.Path\\.data|data =" in packages/hackbot/src (115 matches)',
  },
] as const
