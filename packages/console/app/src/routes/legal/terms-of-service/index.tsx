...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>hackbot | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="hackbot terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <h2 id="what-is-opencode">What is hackbot?</h2>
              <p>
              ...
              <p>
                hackbot takes the privacy of its users very seriously. For the current hackbot Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using hackbot?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by hackbot;
                </li>
                <li>
              ...
              <p>
                If you use hackbot with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                hackbot. Your ability to access Third Party Models is contingent on you having API keys or otherwise
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://example.com/zen</a> for a description of the current Paid
              ...
              <p>
                hackbot is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. hackbot has the sole right to decide whether you are
              ...
              <p>
                ...
                the hackbot Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The hackbot Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the hackbot Parties harmless from and against any and all claims,
              ...
              <p>
                The Rules will govern payment of all arbitration fees. hackbot will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. hackbot will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or hackbot may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and hackbot are instead choosing to have claims and disputes resolved by
                ...
                you and hackbot over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                agreement permits either you or hackbot to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and hackbot agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                are not an employee, agent, partner, or joint venture of hackbot, and you do not have any authority of
                any kind to bind hackbot in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and hackbot
