...
const downloadNames: Record<string, string> = {
  "darwin-aarch64-dmg": "hackbot Desktop.dmg",
  "darwin-x64-dmg": "hackbot Desktop.dmg",
  "windows-x64-nsis": "hackbot Desktop Installer.exe",
...
export async function GET({ params: { platform, channel } }: APIEvent) {
  ...
  const resp = await fetch(
    `https://github.com/hackbot/${channel === "stable" ? "opencode" : "opencode-beta"}/releases/latest/download/${assetName}`,
  )
