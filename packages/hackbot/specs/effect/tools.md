...
Practical reference for the current tool-migration state in `packages/hackbot`.
...
Tool tests should use the existing Effect helpers in `packages/hackbot/test/lib/effect.ts`:
