...
>()("@hackbot/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@hackbot/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.HACKBOT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.HACKBOT_WORKSPACE_ID) : undefined
}
