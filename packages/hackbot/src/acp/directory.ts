...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@hackbot/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@hackbot/ACPDirectory") {}
