...
import { AbsolutePath, type DeepMutable } from "@hackbot/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".hackbot", "plans", "*.md")]: "allow",
