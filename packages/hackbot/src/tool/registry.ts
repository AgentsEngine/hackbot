...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "hackbot-plugin"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/ToolRegistry") {}
