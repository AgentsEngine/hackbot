...
import { locationServiceMapLayer } from "hackbot-core/location-services"
...
import { PartTable, SessionTable } from "hackbot-core/session/sql"
...
import { NonNegativeInt, optional } from "hackbot-core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".hackbot", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/Session") {}
