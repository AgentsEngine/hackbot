...
import { buildPrompt } from "hackbot-core/session/compaction"
import { SessionCompactionEvent } from "hackbot-schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/SessionCompaction") {}
