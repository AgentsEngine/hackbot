...
import { MAX_STEPS_PROMPT } from "@hackbot/core/session/runner/max-steps"
...
import { LLMEvent } from "@hackbot/llm"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/SessionPrompt") {}
