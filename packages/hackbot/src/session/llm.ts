...
import { llmClient } from "@hackbot/core/effect/app-node-platform"
...
import type { LLMEvent } from "@hackbot/llm"
import { LLMClient } from "@hackbot/llm/route"
import type { LLMClientService } from "@hackbot/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over hackbot-llm. It
