...
export class Service extends Context.Service<Service, Interface>()("@hackbot/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __HACKBOT_PHOTON_WASM_PATH?: string }).__HACKBOT_PHOTON_WASM_PATH =
