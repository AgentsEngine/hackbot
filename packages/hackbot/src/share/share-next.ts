...
import type * as SDK from "@hackbot/sdk/v2"
...
import { SessionShareTable } from "@hackbot/core/share/sql"
import { ProviderV2 } from "@hackbot/core/provider"
import { ModelV2 } from "@hackbot/core/model"
import { EventV2 } from "@hackbot/core/event"

const disabled = process.env["HACKBOT_DISABLE_SHARE"] === "true" || process.env["HACKBOT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/ShareNext") {}
