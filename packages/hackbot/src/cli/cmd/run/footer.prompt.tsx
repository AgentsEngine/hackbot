...
import { normalizePromptContent } from "@hackbot/tui/editor"
...
import { HACKBOT_BASE_MODE, useBindings } from "@hackbot/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close hackbot" } satisfies SlashOption,
    ]
