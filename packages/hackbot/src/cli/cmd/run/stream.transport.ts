...
import type { Event, GlobalEvent, OpencodeClient } from "@hackbot/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@hackbot/RunStreamTransport") {}
