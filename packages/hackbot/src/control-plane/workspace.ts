...
import { EventSequenceTable, EventTable } from "hackbot-core/event/sql"
...
import { WorkspaceEvent } from "hackbot-schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        HACKBOT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        HACKBOT_WORKSPACE_ID: config.id,
        HACKBOT_EXPERIMENTAL_WORKSPACES: "true",
