...
import { ProjectDirectoryTable, ProjectTable } from "@hackbot/core/project/sql"
import { ProjectDirectories } from "@hackbot/core/project/directories"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.HACKBOT_FAKE_VCS)
