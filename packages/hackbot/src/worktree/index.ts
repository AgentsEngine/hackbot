...
import { path } from "@hackbot/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@hackbot/core/project"
...
import { WorktreeEvent } from "@hackbot/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `hackbot/${name}`
