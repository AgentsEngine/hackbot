 ...
 *   "@hackbot/ServerAuthConfig",
 *   {
 *     password: Config.string("HACKBOT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("HACKBOT_SERVER_USERNAME").pipe(Config.withDefault("hackbot")),
 *   },
 * ) {}
 *
