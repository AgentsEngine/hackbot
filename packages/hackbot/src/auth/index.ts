...
export class Service extends Context.Service<Service, Interface>()("@hackbot/Auth") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const all = Effect.fn("Auth.all")(function* () {
      if (process.env.HACKBOT_AUTH_CONTENT) {
        try {
          return JSON.parse(process.env.HACKBOT_AUTH_CONTENT)
        } catch (err) {}
      }
