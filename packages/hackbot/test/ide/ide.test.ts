...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders HACKBOT_CALLER", () => {
    process.env["HACKBOT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode HACKBOT_CALLER", () => {
    process.env["HACKBOT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown HACKBOT_CALLER", () => {
    process.env["HACKBOT_CALLER"] = "unknown"
