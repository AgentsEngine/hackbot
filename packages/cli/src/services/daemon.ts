...
import { createOpencodeClient } from "@hackbot/sdk/v2/client"
import { ServerAuth } from "@hackbot/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@hackbot/cli/Daemon") {}
