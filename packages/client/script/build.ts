...
import { compile, emitEffectImported, emitPromise, write } from "@hackbot/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@hackbot/protocol/groups/event"',
            },
          },
        }),
